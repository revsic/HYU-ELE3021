...
- [x] boost
- [x] getlev
- [x] do not switch when inefficient rr ticks
- [ ] ~~tick base -> cmostime based~~

- [x] stride scheduling
- [x] mixing
- [x] set cpu share
- [x] find reason why mlfq runtime on level0 and 1 is similar
- [x] scaling pass
- [x] use constant
- [ ] invalid input tests

- [x] RR time quantum 적용
- [x] stride에서 mlfq로 가면 RR quantum 맞춰서 복귀 - 그냥 RR quantum 중에 stride가 못 가져가게 (약간의 불합리성)
- [x] iterstate 계층마다 상태 분리
